...
export class Grid {
    ...
    initEvents() {
        ...
        window.addEventListener('resize', async () => {
            ...
            const imageTransform = await this.calcTransformImage();
    ...
    smoothScrollToBottom() {
        return new Promise((resolve) => {
            const bottomElement = document.getElementById('more-projects-title');
    ...
    async calcTransformImage() {
        ...
        return {
            ...
            y: winsize.height * 0.60 - (cellrect.top + cellrect.height / 2)
        };
    }
}