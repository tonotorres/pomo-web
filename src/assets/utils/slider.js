...
import { gsap, Expo, Linear, Power4 } from 'gsap';
...
export class Slider {
    constructor() {
      ...
      this.images = [
        require('../images/pomo/marmol-blanco-negro.jpg'),
        require('../images/pomo/marmol-gris.jpg'),
        require('../images/pomo/marmol-negro.jpg'),
    ...
    transitionNext() {
      ...
      if (this.state.initial) {
        gsap.to('.js-scroll', { duration: 1.5, yPercent: 100, alpha: 0, ease: "power4.inOut" })
